...
To run format validation on the `README.md` file, being in the root directory of public-apis-ultra, run:

```bash
$ python scripts/validate/format.py README.md
```

To run link validation on the `README.md` file, being in the root directory of public-apis-ultra, run:
